@extends('layouts.stisla.index', ['title' => 'Halaman Data Barang', 'page_heading' => 'Daftara Barang'])
...
<div class="card">
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <a  href="{{ route('excel.barang.export') }}" class="btn btn-success float-right mt-3 mx-3" data-toggle="tooltip" title="Cetak Semua Data">
      <i class="fas fa-file-excel"></i> Export
      </a>
      <a href="{{ route('barang.print') }}" class="btn btn-success float-right mt-3 mx-3" data-toggle="tooltip" title="Cetak Semua Data">
  ...
  <br>
  <div class="col-lg-12">
     <form method="post" action="{{ route('barang.printfilter') }}" >
     @csrf   
     <div class="input-group">
          ...
          <button type="submit"class="btn btn-success float-left col-lg-12" data-toggle="tooltip" title="Print"><i class="fas fa-fw fa-print"></i>Cetak Data</button>    
</div>
      </form>   
