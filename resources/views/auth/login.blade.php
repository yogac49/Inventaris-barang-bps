...
<head>
    ...
    <title>Login &mdash; BPS Kota Malang</title>
    ...
    <link rel="shortcut icon" href="../assets/img/bpsl.png" type="image/x-icon">
</head>
        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="../assets/img/bpsl.png" alt="logo" width="70" class="shadow-light  mb-5 mt-2">
                        <h5 class="text-dark font-weight-normal">Aplikasi Inventaris Barang<span class="font-weight-bold"> BPS Kota Malang</span></h5>
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                ...
                                <h5 class="font-weight-normal text-muted-transparent">Kota Malang, Jawa Timur</h5>
                            </div>
                        </div>
                    </div>
                </div>
