...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'barang', 'as' => 'barang.'], function () {
        Route::post('/printfilter', 'Commodities\PdfController@generatePdffilter')->name('printfilter');
...
Route::get('/printdata/{tglawal}/{tglakhir}','Commodities\CommodityExportImportController@printdata')->name('printdata');
